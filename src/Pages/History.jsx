      ...
      <div className="w-full xl:w-115 shadow-md p-4 space-y-2">
        ...
        <div className="-mx-4 -my-4 items-center font-bold shadow-md mb-4 p-4">
          <div className="flex justify-between">
            ...
            <button onClick={handleClick} className="left-4">
              <div className="border w-16 h-7 text-sm bg-green-600 text-white flex justify-center items-center rounded-md">
                Saran
              </div>
            </button>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center">
              <div className="space-y-1">
                ...
                <div className="">
                  <h2>
                    Rp33.000 <span className="text-gray-500">(3 Item)</span>
                  </h2>
                </div>
                <div className="flex justify-between">
