...
function Card_Produk() {
  ...
  const handleDelete = (indexToDelete) => {
    const newProduk = produk.filter((_, index) => index !== indexToDelete);
    setProduk(newProduk);
    localStorage.setItem("produk", JSON.stringify(newProduk));
  };
        ...
        >
          ...
          <div className="min-w-[150px] w-full">
            ...
            <div className="relative">
              ...
              {dropdownIndex === index && (
                <div className="absolute top-full w-39 bg-white border border-gray-50 shadow-md rounded-md text-sm">
                  <button
