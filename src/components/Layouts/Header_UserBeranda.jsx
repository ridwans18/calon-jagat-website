            ...
            <div className="flex justify-center sticky top-0 z-40">
                <div className="w-full max-w-md bg-white">
                    <div className="flex justify-between items-start border-l-1 border-r-1 border-gray-200">
                        <div>
                            <h2 className="font-semibold ml-5 mt-3">Sabana Alung - Tanah Merdeka</h2>
                            <p className="text-sm text-gray-600 ml-5 mb-3"><span className="text-green-500 font-medium">Open</span> 10:00 - 17:00</p>
                        </div>
